...
| OMEAD |H,Li,C,N,O,<br>F,Na,S,Cl,Zn,<br>Se,Br| 122 |B3LYP/6–31G(d) | 26K | HOMO, LUMO, EA, IP, E₀ | [Link](https://github.com/rpcarvs/anima/blob/main/databases/OMEAD_26218.csv) |
...
| JARVIS-DFT |Almost full periodic table| PBE+OptB88vdW | >100K | Eg | [Link](https://figshare.com/articles/dataset/jdft_3d-7-7-2018_json/6815699) |
...
| OpenPoly |H,Li,B,C,N,<br>O,F,Na,Si,P,<br>S,Cl,K,Ca,Fe,<br>Zn,Ge,Se,Br,Cd,<br>Sn,I,Te,Pb| Exp | 13k | Eg, Tg, Tensile modulus | [Link](https://cleanenergymaterials.cn/polymer/polymer_database/experiment_polymer_database) |
